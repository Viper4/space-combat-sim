...
//         torpedoes = new Torpedo[populationSize];
...
//         Torpedo firstTorpedo = Instantiate(torpedoPrefab, randomPos, randomRotation).GetComponent<Torpedo>();
...
//         {
//             Torpedo torpedo = Instantiate(torpedoPrefab, randomPos, randomRotation).GetComponent<Torpedo>();
//             torpedoes[i] = torpedo;
